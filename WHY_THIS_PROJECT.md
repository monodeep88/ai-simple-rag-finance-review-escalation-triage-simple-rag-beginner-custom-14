...
**Finance Review Escalation Triage** is not a static prompt demo. It is a runnable full-stack AI application for **Finance Review Escalation Triage Simple RAG - Beginner Custom 14** that demonstrates the core expectations of a **Simple RAG** project at **Beginner** difficulty.
