# Finance Review Escalation Triage

## Project Overview

Finance Review Escalation Triage is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

Finance review escalation triage involves categorizing financial review tasks into Red (high priority), Amber (medium priority), and Green (low priority) based on their urgency and impact.
...
```text
ai-simple-rag-finance-review-escalation-triage-simple-rag-beginner-custom-14/
  backend/
app/
  main.py
  config.py
...
- Tasks with high urgency and high impact are categorized as Red.
- Tasks with medium urgency and medium impact are categorized as Amber.
- Tasks with low urgency and low impact are categorized as Green.
