...
const PROJECT_SUBJECT = "Finance Review Escalation Triage Simple RAG - Beginner Custom 14";
const DOMAIN_SUMMARY = "Finance review escalation triage involves categorizing financial review tasks into Red (high priority), Amber (medium priority), and Green (low priority) based on their urgency and impact.";
const USER_PERSONA = "Finance Reviewer: A finance professional responsible for reviewing financial tasks and escalating them to the next level of priority.";
const STARTER_QUESTIONS = ["What is the urgency of the task?", "What is the impact of the task on the business?", "Who is the task assigned to?"];
