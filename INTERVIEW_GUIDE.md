...
This is a Beginner **Simple RAG** project for **Finance Review Escalation Triage Simple RAG - Beginner Custom 14**. It demonstrates a React user interface, FastAPI backend, retrieval/workflow pipeline, stored run history, Docker setup, and tests.
