...
Build **Finance Review Escalation Triage**, a Beginner Simple RAG application for **Finance Review Escalation Triage Simple RAG - Beginner Custom 14** that turns a user question into an explainable answer with citations, timeline steps, and stored run history.
